    ...
    if vulnerable >= 1 or suspicious >= 1:
        ...
        while True:
            ...
            if response == 'rootex':
                ...
                time.sleep(1)
                print(colored('Executed R-W exploit for {}'.format())) ##### Add rwexp exploit below.
                ...
                print(colored('\n[+] Enter File Name: ','red'),end='')
                file_name = input()
                print('Please Wait Saving In File.')
                time.sleep(2)
                for saved in root_save:
                    with open(file_name,'a') as data:
                        data.write('\nVulnerable to R00T Shell --> ')
                        data.write(saved)
                for ruwd in rwud_save:
                    with open(file_name,'a') as data:
                        data.write('\nVulnerabe to Read-Write-Upload-Download --> ')
                        data.write(ruwd)
                ...
                print(colored('\nAuthor\t: Akash Pandey a.k.a L3V1ATH0N\n','white'))
                print(colored('Exploits from : https://gtfobins.github.io/','white'))
