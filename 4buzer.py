...
ruby_ver = '' # Searching ruby version.
try:
    for ruby in os.listdir('/usr/bin/'):
        if 'ruby2' in ruby:
            ruby_ver = ruby
except:
    ruby_ver = None
...
rwud_vuln = ['x86_64-linux-gnu-ar','arp','atobm','awk','gawk','base32','base64','basenc','busybox','bridge','cat',
        'column','comm','cp','cpio','ksshell','less','look',lua_ver,'lua50','lwp-download','csplit',
        ...
        'red','restic','rev',ruby_ver,'run-mailcap','sed','shuf','soelim','sort','sqlite3','ss','ssh-keyscan','ssh-keygen',
